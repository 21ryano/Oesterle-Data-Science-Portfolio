...
# First, in "Command Prompt" on the Terminal, type "cd Basic_Streamlit_App"
# Second, still in "Command Prompt" still and the Terminal, type "streamlit run PortfolioUpdate1.py"
